...
#
#
# It was decided to move the 'Postman' class functionality to the 'Listener' class - the former emulates
# the client and contains the functionality the client uses, which is very good for test purposes.
# All the additional HTTP requests will be also sent from 'Listener'.
#
#
# class Postman:
#
